...
libraries, binary hash and dependency versions in `BUILD.json`. Node 24.20.0 is the package-build baseline; assessments also support 24.21.0. The x64 and ARM64 packages are built on their
