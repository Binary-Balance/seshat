...
24.20.0 is the package-build baseline; assessments support stable Node versions `>=24.20.0 <25`.
...
release does not claim support for other glibc versions, Alpine, macOS or
