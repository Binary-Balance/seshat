...
Current source accepts Node 24.20.0 and 24.21.0. The published 0.1.0 package
...
listed UTF-8 TypeScript ESM files on Node 24.20.0 or 24.21.0. It is an example adapter,
...
The verified route uses Node 24.20.0 or 24.21.0, Jest 29.7.0, jest-expo 57.0.5, Expo
...
5.0.0 with `@vitest/coverage-istanbul` 5.0.0 and Node 24.20.0 or 24.21.0.
