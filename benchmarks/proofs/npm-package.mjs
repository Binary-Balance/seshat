...
assert.ok(entryReadme.includes('Seshat is a native CLI for TypeScript and TSX complexity analysis and mutation testing.'));
assert.ok(entryReadme.includes('Node.js 24.20.0 or newer'));
assert.ok(entryReadme.includes('npm install --save-dev @binary-balance/seshat'));
assert.ok(entryReadme.includes('seshat mutate --config ./seshat.json'));
assert.ok(entryReadme.includes('https://github.com/Binary-Balance/seshat/blob/main/docs/configuration.md'));
assert.ok(entryReadme.includes('https://github.com/Binary-Balance/seshat/blob/main/docs/report-format.md'));
