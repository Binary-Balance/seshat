...
function selfCheckSummary() {
  ...
  const base = {
    ...
    npm: {kind: 'seshat-release-npm-install', schemaVersion: 1, version: '0.1.0', build: {target: 'aarch64-unknown-linux-gnu', rust: 'rustc 1.98.1', binarySha256: binaryHash, binaryBytes: 1, package: '@binary-balance/seshat-linux-arm64', packageVersion: '0.1.0'}, checks,
