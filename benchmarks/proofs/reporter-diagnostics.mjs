...
install(cwdRoot, 'jest-expo', '57.0.5');
...
try {
  assert.deepEqual(Reporter.executingVersions(executable, 'jest-expo'), {
    jest: '30.5.1',
    'jest-expo': '60.0.0',
  });
  assert.deepEqual(Reporter.executingVersions(executable), {jest: '30.5.1'});
  assert.deepEqual(Reporter.executingVersions(wrapper, 'jest-expo'), {});
} finally {
